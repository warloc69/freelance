<div id="wrapper" class="container">
    ...
    <div class="row">
        ...
        <div class="menu-footer col-sm-3"><div class="well">reit :<?php echo floor($top['avg_reit']);?><br><?php echo $top['first_name'].' '.$top['last_name']; ?></div></div>
        <?php endforeach; ?>
    </div>
    <div id="category" class="row">
        <div id="sidebar" class="col-md-3"><div class="well">3<br>#filters</div></div>
        <div id="featured" class="col-md-12">
            <div class="row">
                <?php foreach ($context as $project) : ?>
                   <?php if(!isset($project['id']) ) continue;?>
                ...
                <div class="text-center">
                    <ul class="pagination">
                        <?php $j = 0 ;for($i=1;$i < $context['total'];$i+=10) : ?>
